<h2>Overview</h2>
<hr>
<p>Use the Carbon Black Defense integration to manage Carbon Black policies, devices and processes on Demisto.</p>
<h2>Use cases</h2>
<hr>
<ul>
